...
def summarize_reports():
    ...
    for f in files:
        ...
        class ReportSummary(YggBaseModel):
            ...
            summary: str = Field(default_factory=str, description="Summarize the report with all relevant information.")
            ...
            table_schema_name: str | None = Field(
                default=None, description="Table schema name if the report is about a table."
            )
